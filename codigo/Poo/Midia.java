...
public abstract class Midia {
    ...
    public int getNumeroVisualizacoes() {
        return visualizacao; // Retorna a quantidade de visualizações da mídia.
    }
    ...
    public double getMediaAvaliacoes() {
        ...
        double somaAvaliacoes = avaliacoes.keySet().stream()
                .mapToDouble(avaliacao -> avaliacoes.get(avaliacao).getNota(null))
                .sum();
