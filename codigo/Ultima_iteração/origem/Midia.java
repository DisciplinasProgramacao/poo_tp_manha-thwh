...
public abstract class Midia {
    ...
    public boolean verificarAcessoLancamento(Espectador espectador) {
        return Profissional.isProfissional(espectador.getProfissional()) && isLancamento();
    }
    ...
    public void adicionarComentario(Espectador espectador, String mensagem) {
        if (Profissional.isProfissional(espectador.getProfissional())) {
            comentarios.add(mensagem);
            System.out.println("Comentário adicionado com sucesso.");
        } else {
            System.out.println("Apenas clientes profissionais podem adicionar comentários.");
        }
    }
